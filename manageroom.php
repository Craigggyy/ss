...
<title>Manage Rooms — DormEase</title>
    ...
    <div class="de-page">
        ...
        <div class="de-page-topbar">
            ...
            <div>
                ...
                <div class="de-page-eyebrow">Key Rack &mdash; Room Inventory</div>

                <h1 class="de-page-heading">Manage Rooms</h1>

            </div>

            <a href="rooms.php" class="btn btn-primary btn-sm">Room Requests</a>
        ...
        <div class="de-page-content">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header bg-primary">Add New Room</div>
            ...
            <div class="card shadow">
                ...
                <div class="card-header bg-danger">All Rooms</div>
