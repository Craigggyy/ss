...
<title>Maintenance — DormEase</title>
    ...
    <div class="de-page">
        ...
        <div class="de-page-topbar">
            ...
            <div>
                ...
                <div class="de-page-eyebrow">Repair Tickets</div>

                <h1 class="de-page-heading">Maintenance</h1>
        ...
        <div class="de-page-content">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header bg-danger">Submit Maintenance Request</div>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea
                                ...
                                class="form-control"
                                rows="4"
                                placeholder="Example: The air conditioner in Room A101 is not cooling properly."
                                required></textarea>
            ...
            <?php if ($_SESSION['role'] == "admin"): ?>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-header bg-primary">Maintenance Management</div>
            ...
            <?php else: ?>
                ...
                <div class="card shadow">
                    ...
                    <div class="card-header bg-primary">My Requests</div>
